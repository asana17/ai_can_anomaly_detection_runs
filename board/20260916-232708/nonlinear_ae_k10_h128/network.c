...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x161c968f934bf0b7a29c605c65c8aeac"
#define _STAI_NETWORK_DATETIME            "2026-09-16T23:31:09+0900"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 28780),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _decoder_decoder_0_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 14376),
      .bias = (float*)(net_ctx->_weights[0] + 19496),
      .n_channel_in = 10,
      .n_channel_out = 128,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN out */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 68),
      .weights = (float*)(net_ctx->_weights[0] + 20008),
      .bias = (float*)(net_ctx->_weights[0] + 28712),
      .n_channel_in = 128,
      .n_channel_out = 17,
      .n_elements = 1,
    };
