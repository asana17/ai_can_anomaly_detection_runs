...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x3e221d14bc273fa502efb8a32093d762"
#define _STAI_NETWORK_DATETIME            "2026-09-16T23:30:34+0900"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 7276),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _decoder_decoder_0_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 3624),
      .bias = (float*)(net_ctx->_weights[0] + 4904),
      .n_channel_in = 10,
      .n_channel_out = 32,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN out */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 68),
      .weights = (float*)(net_ctx->_weights[0] + 5032),
      .bias = (float*)(net_ctx->_weights[0] + 7208),
      .n_channel_in = 32,
      .n_channel_out = 17,
      .n_elements = 1,
    };
