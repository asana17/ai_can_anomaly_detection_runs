...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x539a71a317a801500f3669950f2b3ddb"
#define _STAI_NETWORK_DATETIME            "2026-09-16T23:30:53+0900"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 14444),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _encoder_encoder_2_Gemm_output_0 */
  {
      ...
      .bias = (float*)(net_ctx->_weights[0] + 7168),
      .n_channel_in = 64,
      .n_channel_out = 10,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN _decoder_decoder_0_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 7208),
      .bias = (float*)(net_ctx->_weights[0] + 9768),
      .n_channel_in = 10,
      .n_channel_out = 64,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN out */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 68),
      .weights = (float*)(net_ctx->_weights[0] + 10024),
      .bias = (float*)(net_ctx->_weights[0] + 14376),
      .n_channel_in = 64,
      .n_channel_out = 17,
      .n_elements = 1,
    };
