...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0xc57a1e60fee35ed8a0c2bd33c0e8660a"
#define _STAI_NETWORK_DATETIME            "2026-09-16T23:31:27+0900"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 7796),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _encoder_encoder_2_Gemm_output_0 */
  {
      ...
      .bias = (float*)(net_ctx->_weights[0] + 3840),
      .n_channel_in = 32,
      .n_channel_out = 12,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN _decoder_decoder_0_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 3888),
      .bias = (float*)(net_ctx->_weights[0] + 5424),
      .n_channel_in = 12,
      .n_channel_out = 32,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN out */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 68),
      .weights = (float*)(net_ctx->_weights[0] + 5552),
      .bias = (float*)(net_ctx->_weights[0] + 7728),
      .n_channel_in = 32,
      .n_channel_out = 17,
      .n_elements = 1,
    };
