...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x80aa78f4c421f7239b6edc72c546738b"
#define _STAI_NETWORK_DATETIME            "2026-09-16T23:31:43+0900"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 15476),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _encoder_encoder_2_Gemm_output_0 */
  {
      ...
      .bias = (float*)(net_ctx->_weights[0] + 7680),
      .n_channel_in = 64,
      .n_channel_out = 12,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN _decoder_decoder_0_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 7728),
      .bias = (float*)(net_ctx->_weights[0] + 10800),
      .n_channel_in = 12,
      .n_channel_out = 64,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN out */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 68),
      .weights = (float*)(net_ctx->_weights[0] + 11056),
      .bias = (float*)(net_ctx->_weights[0] + 15408),
      .n_channel_in = 64,
      .n_channel_out = 17,
      .n_elements = 1,
    };
