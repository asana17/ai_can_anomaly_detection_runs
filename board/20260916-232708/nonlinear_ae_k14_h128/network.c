...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x6c83c49ed044002ee7ee301b01a0c372"
#define _STAI_NETWORK_DATETIME            "2026-09-16T23:32:50+0900"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 32892),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _encoder_encoder_2_Gemm_output_0 */
  {
      ...
      .bias = (float*)(net_ctx->_weights[0] + 16384),
      .n_channel_in = 128,
      .n_channel_out = 14,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN _decoder_decoder_0_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 16440),
      .bias = (float*)(net_ctx->_weights[0] + 23608),
      .n_channel_in = 14,
      .n_channel_out = 128,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN out */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 68),
      .weights = (float*)(net_ctx->_weights[0] + 24120),
      .bias = (float*)(net_ctx->_weights[0] + 32824),
      .n_channel_in = 128,
      .n_channel_out = 17,
      .n_elements = 1,
    };
