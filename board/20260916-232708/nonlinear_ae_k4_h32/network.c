...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x315c86db7117042318ac37c4a750d226"
#define _STAI_NETWORK_DATETIME            "2026-09-16T23:28:11+0900"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 5716),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _encoder_encoder_2_Gemm_output_0 */
  {
      ...
      .bias = (float*)(net_ctx->_weights[0] + 2816),
      .n_channel_in = 32,
      .n_channel_out = 4,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN _decoder_decoder_0_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 2832),
      .bias = (float*)(net_ctx->_weights[0] + 3344),
      .n_channel_in = 4,
      .n_channel_out = 32,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN out */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 68),
      .weights = (float*)(net_ctx->_weights[0] + 3472),
      .bias = (float*)(net_ctx->_weights[0] + 5648),
      .n_channel_in = 32,
      .n_channel_out = 17,
      .n_elements = 1,
    };
