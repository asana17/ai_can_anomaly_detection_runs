...
const stai_network_details g_network_details = {
  .tensors = (const stai_tensor[7]) {
   ...
   { .size_bytes = 16, .flags = (STAI_FLAG_HAS_BATCH|STAI_FLAG_CHANNEL_LAST), .format = STAI_FORMAT_FLOAT32, .shape = {2, (const int32_t[2]){1, 4}}, .scale = {0, NULL}, .zeropoint = {0, NULL}, .name = "_encoder_encoder_2_Gemm_output_0_output" },
