...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x9e1557178a1972875434e0defaaeeec6"
#define _STAI_NETWORK_DATETIME            "2026-09-16T23:29:18+0900"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 12380),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _encoder_encoder_2_Gemm_output_0 */
  {
      ...
      .bias = (float*)(net_ctx->_weights[0] + 6144),
      .n_channel_in = 64,
      .n_channel_out = 6,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN _decoder_decoder_0_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 6168),
      .bias = (float*)(net_ctx->_weights[0] + 7704),
      .n_channel_in = 6,
      .n_channel_out = 64,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN out */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 68),
      .weights = (float*)(net_ctx->_weights[0] + 7960),
      .bias = (float*)(net_ctx->_weights[0] + 12312),
      .n_channel_in = 64,
      .n_channel_out = 17,
      .n_elements = 1,
    };
