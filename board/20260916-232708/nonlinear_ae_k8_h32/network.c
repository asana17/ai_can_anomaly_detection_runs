...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0x5735a2e2e273a73f5114e8fab9872e0b"
#define _STAI_NETWORK_DATETIME            "2026-09-16T23:29:49+0900"
...
static const stai_network_info g_network_info = {
  ...
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 6756),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
static const ai_i32 _encoder_encoder_1_Relu_output_0_t_in_0_shape_ch_prod_const_s32 = 32;



static const ai_i32 _decoder_decoder_1_Relu_output_0_t_in_0_shape_ch_prod_const_s32 = 32;
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _encoder_encoder_0_Gemm_output_0 */
  {
      ...
      .bias = (float*)(net_ctx->_weights[0] + 2176),
      .n_channel_in = 17,
      .n_channel_out = 32,
      .n_elements = 1,
    };
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(1, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 68)});
  }
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(2, 1, {(stai_ptr) _encoder_encoder_1_Relu_output_0_t_in_0_ptr_const_handle});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(2, 1, {(stai_ptr) _encoder_encoder_1_Relu_output_0_t_out_0_ptr_handle});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN _encoder_encoder_2_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 2304),
      .bias = (float*)(net_ctx->_weights[0] + 3328),
      .n_channel_in = 32,
      .n_channel_out = 8,
      .n_elements = 1,
    };
  
  _STAI_NETWORK_EVENT_NODE_START_CB(3, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 68)});
  ...
  /* LITE_KERNEL_SECTION BEGIN _decoder_decoder_0_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 3360),
      .bias = (float*)(net_ctx->_weights[0] + 4384),
      .n_channel_in = 8,
      .n_channel_out = 32,
      .n_elements = 1,
    };
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(4, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 68)});
  }
  ...
  _STAI_NETWORK_EVENT_NODE_START_CB(5, 1, {(stai_ptr) _decoder_decoder_1_Relu_output_0_t_in_0_ptr_const_handle});
  ...
  _STAI_NETWORK_EVENT_NODE_STOP_CB(5, 1, {(stai_ptr) _decoder_decoder_1_Relu_output_0_t_out_0_ptr_handle});
  }
  ...
  /* LITE_KERNEL_SECTION BEGIN out */
  {
      ...
      .input = (float*)(net_ctx->_activations[0] + 68),
      .weights = (float*)(net_ctx->_weights[0] + 4512),
      .bias = (float*)(net_ctx->_weights[0] + 6688),
      .n_channel_in = 32,
      .n_channel_out = 17,
      .n_elements = 1,
    };
  
  _STAI_NETWORK_EVENT_NODE_START_CB(6, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 68)});
    
  forward_lite_dense_if32of32wf32((forward_lite_dense_if32of32wf32_args*)&arg_30f51e);
    
  _STAI_NETWORK_EVENT_NODE_STOP_CB(6, 1, {(stai_ptr) (float*)(net_ctx->_outputs[0] + 0)});
  }
